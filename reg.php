                        ...
                        <div class="tab-content w-100" id="myTabContent">
                            <div class="tab-pane   fade show active" id="login" role="tabpanel" aria-labelledby="home-tab">
                               ...
                               <div class="form-row">
                                   ...
                                   <input placeholder="Enter Username" class="form-control form-control-sm" type="text" name="uname">
                               </div>
                               
                               <div class="form-row">
                                  
                                   <input placeholder="Enter Password" class="form-control form-control-sm" type="text" name="password">
                               </div>
                               
                                <div class=" forget">
                                  
                                   <p> forget password ?</p>
                                <button class="btn btn-success btn-sm">Click to Login</button>
                               </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="signup" role="tabpanel" aria-labelledby="profile-tab">
                               ...
                               <div class="form-row">
                                   ...
                                   <input placeholder="Enter Full Name" class="form-control form-control-sm" type="text" name="name">
                               </div>
                               
                               <div class="form-row">
                                  
                                   <input placeholder="Enter Email Address" class="form-control form-control-sm" type="text" name="email">
                               </div>
                                <div class="form-row">
                                ...
                                <div class="form-row">
                                   ...
                                   <input placeholder="Contact Number" class="form-control form-control-sm" type="text" name="contact">
                               </div>
                               <div class=" forget">
                                  <br>
                                  
                                <button class="btn btn-success w-100 btn-sm">Click to Signup</button>
                               </div>
                                </div>
                            </div>
