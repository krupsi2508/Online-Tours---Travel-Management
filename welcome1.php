...
<h1 style="font-size:36px; color:#09F;font-weight:bold;text-align:center;">Welcome</h1><br>  
<h2 style="font-size:28px; color:#09F;font-weight:bold;text-align:center;">
<?php  
echo $_SESSION['email'];  
?> </h2>  
